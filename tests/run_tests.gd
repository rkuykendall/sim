...
func _init() -> void:
	...
	for suite_script in [_IntegrationTests, _PathfindingTests, _LifecycleTests, _SaveLoadTests, _AISystemTests, _MultiPawnTests, _WorkAndHaulTests, _BuffMoodTests, _PaintingTests, _QueriesTests]:
